...
\section{Entrauschen: Filter \& Co.}
    ...
    \[f(x) = \frac{1}{(2 \pi)^\frac{d}{2}} \int_{\R^d} (\frac{1}{(2 \pi)^\frac{d}{2}} \int_{\R^d} f(y) e^{-i \skprod{z}{y}} dy) e^{i \skprod{z}{x}} dz\]
