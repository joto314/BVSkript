...
\section{Entrauschen: Filter \& Co.}
    ...
    \subsection{Glättungsfilter}
        ...
        \begin{enumerate}[label=\framebox{\arabic *}]
            ...
            \item $\tilde f * \tilde g = \widetilde{f * g}$, kompatibel mit Spiegelung
        \end{enumerate}
        ...
        \begin{enumerate}[label=\framebox{\arabic *'}]
            ...
            \item $\tilde f \boxast \tilde g = \tilde{\tilde f} * \tilde g \overset{\framebox{\small 3}}{=} \widetilde{(\tilde f * g)} = \widetilde{f \boxast g}$, kompatibel mit Spiegelung
        \end{enumerate}
